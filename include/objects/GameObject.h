...
class GameObject final : public std::enable_shared_from_this<GameObject> {
 ...
 public:
  ...
  [[nodiscard]] inline const std::weak_ptr<GameObject>& parent() const
      noexcept {
    return parent_;
  }
  ...
  [[nodiscard]] inline const std::weak_ptr<Transform>& transform() const
      noexcept {
    return transform_;
  }

  [[nodiscard]] inline const std::weak_ptr<PhysicsBody>& physics() const
      noexcept {
    return physics_;
  }
  ...
  template <typename T>
  [[nodiscard]] inline std::shared_ptr<T> getComponentInChildren() const
      noexcept {
  ...
  template <typename T>
  [[nodiscard]] inline std::shared_ptr<T> getComponentInParent() const
      noexcept {
